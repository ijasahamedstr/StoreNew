...
export default function EncyclopediaofDisability() {
  // List of items to display in the unordered list
  const items = ['جمعية الإعاقة الحركية', 'مركز التأهيل الشامل'];
    ...
    >
      ...
      <div style={{width: '100%', padding: '0 20px',paddingRight:'100px' }}>
          ...
          style={{
            ...
            paddingRight: '20px', 
            marginBottom: '10px', 
            fontSize: '100px',  // Large font size for each list item
            color: '#0d8f75',
            display: 'flex',
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  fontSize: { xs: '12px', sm: '15px', md: '85px' },  // Responsive font size
